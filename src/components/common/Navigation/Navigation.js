      ...
      <div className="nav-header">
        ...
        <div className="user-profile">
          <div className="profile-dropdown" ref={dropdownRef}>
            <button className="profile-button" onClick={() => setShowDropdown(!showDropdown)} aria-label="Settings menu">
      ...
      <div className="nav-tabs">
        {navItems.map((item, index) => (
          <React.Fragment key={index}>
            <Link to={item.path} className={`nav-tab ${location.pathname === item.path ? 'active' : ''}`}>
              {item.name}
            </Link>
